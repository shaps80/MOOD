...
@frozen public struct ProposedViewSize: Equatable, Sendable {
    ...
    /// value.
    public static var zero: ProposedViewSize { .init(width: 0, height: 0) }
    ...
    /// ``Layout/sizeThatFits(proposal:subviews:cache:)`` method for this
    /// value.
    public static var unspecified: ProposedViewSize { .init(width: nil, height: nil) }

    /// A size proposal that contains infinity in both dimensions.
    ///
    /// Both dimensions contain
    /// <doc://com.apple.documentation/documentation/CoreGraphics/Double/1454161-infinity>
    ...
    /// ``Layout/sizeThatFits(proposal:subviews:cache:)`` method for this
    /// value.
    public static var infinity: ProposedViewSize { .init(width: .infinity, height: .infinity) }
