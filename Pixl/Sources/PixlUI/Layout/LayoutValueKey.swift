...
/// like ``Element/layoutPriority(_:)`` and ``Element/zIndex(_:)``, but have a
...
/// optional <doc://com.apple.documentation/documentation/CoreFoundation/Double>
/// from this definition.
///
/// ### Set a value on a view
///
/// Set the value on a view by adding the ``Element/layoutValue(key:value:)``
...
///
///     extension Element {
///         func layoutFlexibility(_ value: Double?) -> some Element {
...
public protocol LayoutValueKey {
    ...
    /// <doc://com.apple.documentation/documentation/CoreGraphics/Double>.
    ///
    /// Any view that you don't explicitly set a value for uses the default
