...
///   see ``Element/alignmentGuide(_:computeValue:)-9mdoh``.
...
/// closure you provide to the ``Element/alignmentGuide(_:computeValue:)-6y3u2``
...
///
///     struct ViewDimensionsOffset: Element {
...
/// direction.
///
/// You can see this if you use the ``Element/environment(_:_:)``
