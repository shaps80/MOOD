...
///
///     private struct HorizontalAlignmentGallery: Element {
...
///         }
///
///         private func column(alignment: HorizontalAlignment, text: String) -> some Element {
...
/// particular view using the ``Element/alignmentGuide(_:computeValue:)-9mdoh``
/// view modifier.
///
/// ### Layout direction
///
...
/// these. You can see this by using the ``Element/environment(_:_:)`` view
...
/// ``Element/alignmentGuide(_:computeValue:)-9mdoh`` view modifier.
...
///
///     struct LayeredVerticalStripes: Element {
///         var body: some Element {
...
///         }
///
///         private func verticalStripes(color: Color) -> some Element {
///             HStack(spacing: 1) {
...
extension HorizontalAlignment {
    ...
    ///     }
    ///
    public static var leading: HorizontalAlignment { .init(HLeading.self) }
    ...
    ///     }
    ///
    public static var center: HorizontalAlignment { .init(HCenter.self) }
    ...
    ///     }
    ///
    public static var trailing: HorizontalAlignment { .init(HTrailing.self) }
}
