...
/// ``Element/overlay(alignment:content:)`` or
/// ``Element/background(alignment:content:)``, respectively. During layout,
...
///
///     struct AlignmentGallery: Element {
...
///         }
///
///         private func box(_ name: String) -> some Element {
///             Text(name)
...
///     }
///
///     private struct BackgroundView: Element {
///         var body: some Element {
...
extension Alignment {
    ...
    public static var trailing: Alignment {
        .init(horizontal: .trailing, vertical: .center)
    }
    ...
    public static var top: Alignment {
        .init(horizontal: .center, vertical: .top)
    }
    ...
    public static var bottom: Alignment {
        .init(horizontal: .center, vertical: .bottom)
    }
    ...
    public static var topLeading: Alignment {
        .init(horizontal: .leading, vertical: .top)
    }
    ...
    public static var topTrailing: Alignment {
        .init(horizontal: .trailing, vertical: .top)
    }
    ...
    public static var bottomLeading: Alignment {
        .init(horizontal: .leading, vertical: .bottom)
    }
    ...
    public static var bottomTrailing: Alignment {
        .init(horizontal: .trailing, vertical: .bottom)
    }
}
