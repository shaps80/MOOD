...
///     }
///
///     struct HorizontalStripes: Element {
///         var body: some Element {
///             VStack(spacing: 1) {
...
///
///     struct StripesGroupModified: Element {
///         var body: some Element {
///             HStack(alignment: .firstThird, spacing: 1) {
///                 HorizontalStripes().frame(height: 60)
///                 HorizontalStripes().frame(height: 120)
...
public protocol AlignmentID: SendableMetatype {
    ...
    /// ``Element/alignmentGuide(_:computeValue:)-9mdoh`` view modifier to a
    /// particular view.
    ///
