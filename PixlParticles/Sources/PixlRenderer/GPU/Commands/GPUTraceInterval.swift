...
public struct GPUTraceInterval: Sendable {
    ...
    public let computePhase: GPUComputePhase?
    public let phase: Phase
    public let start: Double
    public let end: Double
    public let frameID: UInt64
    public let captureID: UInt64
    public init(phase: Phase, start: Double, end: Double, frameID: UInt64, captureID: UInt64, computePhase: GPUComputePhase? = nil) {
